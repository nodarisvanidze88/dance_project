...
from .views import LoginView,LogoutView, RegisterView, UserChangeDetailsViews, UserEmailVerificationView, UserDetails, GoogleAuthView, UserEmailVerificationResendView,UserPhoneVerificationResendView, UserPhoneVerificationView
urlpatterns = [
